...
def GinVim()
  ...
  OverrideFunction.new(
    gin#internal#util#ansi_escape_code#colors,
    Patched_list_colors
  ).Call()
enddef

# https://www.ditig.com/256-colors-cheat-sheet
const XTERM_256_COLORS =<< trim END
  #000000
  #800000
  #008000
  #808000
...
def Patched_list_colors(): list<string>
  if exists('g:terminal_ansi_colors')
    return g:terminal_ansi_colors + XTERM_256_COLORS[16 :]
  else
    return XTERM_256_COLORS
  endif
enddef
# }}}
